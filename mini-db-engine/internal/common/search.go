...
func BinarySearch(keys []storage.CompositeKey, target storage.CompositeKey) int {
...
func BinarySearchLastLessOrEqual(keys []storage.CompositeKey, target storage.CompositeKey) int {
	left, right := 0, len(keys)-1
	pos := -1
...
func BinarySearchFirstGreaterOrEqual(keys []storage.CompositeKey, target storage.CompositeKey) int {
	left, right := 0, len(keys)-1
...
func BinarySearchInsertPosition(keys []storage.CompositeKey, target storage.CompositeKey) int {
	left, right := 0, len(keys)-1

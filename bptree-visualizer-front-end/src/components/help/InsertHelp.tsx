    ...
    <ScrollArea className="h-full pr-4">
      <div className="space-y-6">
        ...
        <div className="bg-muted/50 p-4 rounded-lg border">
          <h3 className="text-2xl font-semibold mb-3 text-primary">Detailed Split Logic</h3>
          
          <div className="space-y-4">
            <div>
              <h4 className="font-semibold text-foreground text-lg">1. Leaf Node Split</h4>
            ...
            <div>
              <h4 className="font-semibold text-foreground text-lg">2. Internal Node Split</h4>
              <ul className="list-disc ml-5 mt-1 text-base text-muted-foreground space-y-1">
             ...
             <div>
              <h4 className="font-semibold text-foreground text-lg">3. Root Split</h4>
              <ul className="list-disc ml-5 mt-1 text-base text-muted-foreground space-y-1">

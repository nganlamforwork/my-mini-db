...
export const RangeHelp: React.FC = () => {
  const steps = [
    ...
    <div className="space-y-4 flex flex-col h-full" key="step1">
       ...
       <div className="bg-muted/30 p-4 rounded-lg flex items-center justify-center min-h-[220px] border border-dashed flex-1">
    ...
    <div className="space-y-4 flex flex-col h-full" key="step2">
       ...
       <div className="bg-muted/30 p-4 rounded-lg flex items-center justify-center min-h-[220px] border border-dashed flex-col gap-2 flex-1">
    ...
    <div className="space-y-4 flex flex-col h-full" key="step3">
       ...
       <div className="bg-muted/30 p-4 rounded-lg flex items-center justify-center h-32 border border-dashed flex-1">
  ...
  return (
    <ScrollArea className="h-full pr-4">
      <div className="space-y-8 flex flex-col h-full"> 
        ...
        <HelpStepWizard 
           steps={steps} 
           showAllClassName="grid grid-cols-1 lg:grid-cols-2 gap-8"
           className="flex-1"
        />
      </div>
    </ScrollArea>
